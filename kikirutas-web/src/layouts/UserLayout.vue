<template>
  <div class="min-h-screen flex bg-gray-50 text-gray-800 font-sans">
    ...
    <aside
      class="hidden md:block w-[280px] p-6 sticky top-0 h-screen overflow-y-auto border-r border-gray-200 bg-white">
      <div class="flex flex-col h-full">
        ...
        <nav class="space-y-1 flex-1">
          ...
          <RouterLink :to="{ name: 'u.pedido.nuevo' }" class="nav-link"
          ...
          <RouterLink :to="{ name: 'u.historial' }" class="nav-link"
            :class="{ active: isActive('/usuario/historial') }">
            <svg viewBox="0 0 24 24" class="icon">
          ...
          <RouterLink :to="{ name: 'u.alertas' }" class="nav-link" :class="{ active: isActive('/usuario/alertas') }">
            ...
            <span v-if="alertasStore.noLeidasCount > 0"
              class="ml-auto bg-chile text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm">{{
                alertasStore.noLeidasCount }}</span>
          </RouterLink>
        ...
        <div class="mt-8 pt-4 border-t border-gray-100">
          <button
            class="w-full flex items-center justify-center gap-2 bg-red-50 text-red-600 font-semibold py-3 rounded-xl hover:bg-red-100 transition-colors"
            @click="onLogout">
        ...
        <div class="px-4 py-3 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <RouterLink :to="{ name: 'u.alertas' }" class="relative text-gray-500 hover:text-brand transition-colors">
              ...
              <span v-if="alertasStore.noLeidasCount > 0"
                class="absolute -top-1 -right-1 bg-chile w-2.5 h-2.5 rounded-full border-2 border-white"></span>
            </RouterLink>
