      ...
      <div class="menu-panel relative overflow-hidden sticky top-4">
        ...
        <div class="relative z-10">
          ...
          <nav class="p-3 space-y-1 text-sm">
            ...
            <RouterLink :to="{name:'u.pedido.nuevo'}" class="link" :class="{active:isActive('/usuario/pedido/nuevo')}">
...
.link:hover{ background: rgba(34,167,136,.10); color:#fff; }
...
/* Botón salir */
.btn-danger{
  background:#e5484d; color:white; font-weight:600;
