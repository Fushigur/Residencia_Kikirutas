    ...
    <header class="sticky top-0 z-10 border-b border-white/10 backdrop-blur md:static">
      <div class="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <router-link :to="{ name: 'a.resumen' }" class="flex items-center gap-3">
          <img src="@/assets/img/Logo.png" alt="KikiRutas — Administración"
        ...
        <nav class="ml-auto hidden md:flex items-center gap-2">
          <router-link :to="{ name: 'a.resumen' }" class="btn-ghost"
            :class="{ active: isActive('a.resumen') }">Resumen</router-link>

          <router-link :to="{ name: 'a.pedidos' }" class="btn-ghost"
            :class="{ active: isActive('a.pedidos') }">Pedidos</router-link>

          <router-link :to="{ name: 'a.rutas' }" class="btn-ghost"
            :class="{ active: isActive('a.rutas') }">Rutas</router-link>

          <router-link :to="{ name: 'a.usuarios' }" class="btn-ghost"
            :class="{ active: isActive('a.usuarios') }">Usuarios</router-link>

          <router-link :to="{ name: 'a.productos' }" class="btn-ghost"
            :class="{ active: isActive('a.productos') }">Productos</router-link>

          <router-link :to="{ name: 'a.reportes' }" class="btn-ghost"
