...
// Filtramos solo alertas de tipo pedido para este componente, o todas si se prefiere.
// El usuario dijo "alertas de pedidos".
const alert = computed(() => items.value.find(a => a.tipo === 'pedido' && !a.leida))
